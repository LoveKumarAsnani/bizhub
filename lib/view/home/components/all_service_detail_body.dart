    ...
    return Consumer<AllServicesViewModel>(
      ...
      return SingleChildScrollView(
        child: Padding(
          ...
          child: allServiceViewModel.serviceDetalModel == null
              ? const Text("null")
              : Column(
                    ...
                    SizedBox(
                      ...
                      child: allServiceViewModel
                          ...
                          ? Container(
                              ...
                              color: Colors.black,
                              child:
                                  Image.asset('assets/images/bizhub_logo.png'),
                            )
                          : ListView.builder(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: bottomNavigationViewModel.token == null ||
                                ...
                                ? null
                                : () {
                                    if (allServiceViewModel.serviceDetalModel!
                                            .user!.firstName !=
                                        'Guest') {
                                      Navigator.push(
                                        context,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      if (allServiceViewModel.serviceDetalModel!
                                                  .user!.firstName !=
                                              'Guest' &&
                                          allServiceViewModel.serviceDetalModel!
                                                  .user!.firstName !=
                                              'User')
